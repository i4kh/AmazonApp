...
const Action = (props) => { 
    ...
    const [ yardMarshals, getYardMarshals ] = useState();
    const YMcounter = (e) => {
    ...
    const [ pickStage, getPickStage] = useState();
    const pickCounter = (e) => {
        e.preventDefault();
    ...
    const [ problemSolve, getProblemSolve] = useState();
    const psCounter = (e) => {
    ...
    const [ specialAssignment, getSpecialAssignment] = useState();
    const SACounter = (e) => {
    ...
    const [ badgeCheck, getBadgeCheck] = useState();
    const BCCounter = (e) => {
